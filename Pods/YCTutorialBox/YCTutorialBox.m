 ...
 */
- (instancetype)initWithHeadline:(NSMutableAttributedString *)headline;
{
 ...
 */
- (instancetype)initWithHeadline:(NSMutableAttributedString *)headline
                    withHelpText:(NSMutableAttributedString *)helpText;
{
             ...
             withCompletionBlock:(void (^)())completion;
{
    ...
    if (self) {
        ...
        /// Set the texts.
        _boxHeadline.attributedText = headline;
        _boxHelpText.attributedText = helpText;
